<template>
    <div style="position: relative; display: inline-block;">
        ...
        <transition name="slide-fade" mode="out-in">
            <div class="daterangepicker dropdown-menu ltr" :class="pickerStyles()" v-show="open">
                <div class="calendar left">
                    ...
                    <div class="calendar-table">
                        <calendar :monthDate="monthDate" :locale="locale"
                                  :start="start" :end="end"
                ...
                <div class="calendar right">
                    ...
                    <div class="calendar-table">
                        <calendar :monthDate="nextMonthDate" :locale="locale"
                                  :start="start" :end="end"
                                  @nextMonth="nextMonth" @prevMonth="prevMonth"
                                  @dateClick="dateClick" @hoverDate="hoverDate"
                        ></calendar>
                ...
                <calendar-ranges :canSelect="in_selection" @clickCancel="open=false"
                                 @clickApply="clickedApply" :ranges="ranges"></calendar-ranges>
            </div>
        </transition>
    </div>
</template>
